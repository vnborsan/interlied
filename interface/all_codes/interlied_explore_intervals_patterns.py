...
*Input: dataframe obtained by interlied_intervals or interlied_pattern_analysis functions.
...
def intervals_lyric():
    ...
    root.title("Explore Intervals & Patterns")
    ...
    label_q1 = ttk.Label(q_frame, text="Insert Interval / Pattern")
